    ...
    <main className={styles.main}>
      ...
      <div className={styles.who_are_we}>
        ...
        <div className={styles.developer_profile_cards}>
          ...
          <div className={styles.developer_profile_card}>
            <div className={styles.developer_profile_card_top_section}>
              <img src="" className={styles.developer_profile_card_photo} />

              <div className={styles.developer_profile_card_top_section_text}>
                <h1 className={styles.developer_profile_card_name}>
                  <a className={styles.small_margin_top}></a> Chris Marshall
                  <a className={styles.developer_profile_card_position}>- Founder / CEO</a>
                  <a className={styles.developer_profile_card_location}><br />🏴󠁧󠁢󠁳󠁣󠁴󠁿 Scotland, United Kingdom</a>
                </h1>
              </div>
            </div>

            <div className={styles.developer_profile_card_bottom_section}>
              <p className={styles.developer_profile_card_description_text}>Hi, I'm Chris! I'm a passionate developer with six years of coding experience. I have extensive knowledge of various programming languages and frameworks, and I'm always eager to expand my skills. I'm excited to work with you!</p>
            </div>
      ...
      <div className={styles.what_others_say} id="what-others-say">
        ...
        <div className={styles.testimonial_cards}>
          <div className={styles.testimonial_card}>
            ...
            <h1 className={styles.testimonial_title_text}><a className={styles.recent_review}>RECENT REVIEW</a> James P - <a className={styles.testimonial_location}>United Kingdom</a></h1>
